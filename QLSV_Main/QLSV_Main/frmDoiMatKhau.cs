...
namespace QLSV_Main
{
    ...
    {        
        ...
        public frmDoiMatKhau(string maSo, string hoTen, string loaiTK,string email)
        {
            this.maSo = maSo;
            this.hoTen = hoTen;
            this.loaiTK = loaiTK;
        ...
        private void btnXacNhan_Click(object sender, EventArgs e)
        {
            ...
            {
                var mk = textToMd5.converText(txtMKcu.Text);                
            ...
            else
            {
                ...
                {
                    var mkMoi = textToMd5.converText(txtMKmoi.Text);  
